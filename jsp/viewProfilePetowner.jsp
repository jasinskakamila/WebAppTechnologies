...
<%
  ...
  User userObj2023 = (User) session.getAttribute("userObj2023");

    // Check if the user is not signed in
  if (userObj2023 == null) {
      // Set an error message in the request attribute
      request.setAttribute("message", "You must first register or sign in.");
    ...
    <div class="rt-container">
    	<div class="col-rt-12">
        	<div class="rt-heading">
            	<h1>Welcome to your profile <code><%= userObj2023.getUsername()%></code></h1>
      ...
      <div class="col-lg-4">
        <div class="card shadow-sm">
          <div class="card-header bg-transparent text-center">
            <img class="profile_img"  src="../images/photoprof.jpg" style="border-radius: 50%; margin-right: 0.5cm;">
            <!--Displays the username -->
            <h3><code><%= userObj2023.getUsername()%></code></h3>
          </div>
          <div class="card-body">
            <p class="mb-0"><strong class="pr-1">Email:</strong><code><%= userObj2023.getEmail()%></code></p>
          </div>
        </div>
      </div>
      <div class="col-lg-8">
          ...
          <div class="card-body pt-0">
            <table class="table table-bordered">
              <tr>
                ...
                <td width="2%">:</td>
                <td><code><%= userObj2023.getUsername()%></code></td>
              </tr>
              <tr>
                <th width="30%">First Name</th>
                <td width="2%">:</td>
                <td><code><%= userObj2023.getFirstName()%></code></td>
              </tr>
              <tr>
                <th width="30%">Last Name</th>
                <td width="2%">:</td>
                <td><code><%= userObj2023.getLastName()%></code></td>
              </tr>
              <tr>
                <th width="30%">Phone</th>
                <td width="2%">:</td>
                <td><code><%= userObj2023.getPhoneNum()%></code></td>
              </tr>
            </table>
          </div>
        </div>
