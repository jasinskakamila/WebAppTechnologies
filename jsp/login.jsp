  ...
  <style>
    ...
    * {
    ...
    .container:before {
      ...
      background-image: linear-gradient(-45deg, #d58517 0%, #a38254 100%);
    ...
    /* Add this CSS code to style the line */
    .line {
      width: 100%;  /* Make the line span the full width */
      height: 1%;  /* Set the height of the line */
      background-color: #fffffe;  /* Choose your desired line color */
      margin-top: -220px;  /* Adjust the margin to position the line as needed */
    }

    #sign-up-btn {
    color: white;        /* Changes text color to white */
    background-color: transparent; /* Optional: ensures the button background is transparent */
    }
...
<body>
  ...
  <% if(request.getAttribute("message") != null) { %>  
    <div id="popup" class="text-center">
      <p>
          ...
          <img src="../images/logo.jpg" width="150" height="75" style="display: block; margin: 0 auto;">
    ...
    <div class="forms-container">
      <div class="signin-signup">
        <form action="loginController.jsp" method="post" class="sign-in-form">
          <h2 class="title">Welcome to help2pet</h2>
          <div class="input-field">
            <i class="fas fa-user"></i>
            <input type="text" name="usernameLog" id="usernameLog" placeholder="Username" />
          </div>
          <div class="input-field">
        ...
        <form action="registerController.jsp" method="post" class="sign-up-form">
          ...
          <div class="input-field">
            ...
            <input type="phone" name="phoneNum" id="phoneNum" placeholder="Contact phone" />
          </div>
  ...
  <script>
    // Function to show the popup and hide it after a delay
    function showPopup() {
